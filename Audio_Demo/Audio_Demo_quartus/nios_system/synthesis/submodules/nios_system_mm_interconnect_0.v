...
module nios_system_mm_interconnect_0 (
	...
	wire    [9:0] cmd_mux_src_channel;                                                                // cmd_mux:src_channel -> audio_0_avalon_audio_slave_agent:cp_channel
	...
	wire    [9:0] cmd_mux_001_src_channel;                                                            // cmd_mux_001:src_channel -> audio_and_video_config_0_avalon_av_config_slave_agent:cp_channel
	...
	wire  [104:0] cmd_mux_003_src_data;                                                               // cmd_mux_003:src_data -> sysid_control_slave_agent:cp_data
	...
	wire  [104:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> nios2_gen2_0_debug_mem_slave_agent:cp_data
	...
	wire  [104:0] cmd_mux_005_src_data;                                                               // cmd_mux_005:src_data -> onchip_memory2_1_s1_agent:cp_data
	wire          cmd_mux_005_src_ready;                                                              // onchip_memory2_1_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire    [9:0] cmd_mux_005_src_channel;                                                            // cmd_mux_005:src_channel -> onchip_memory2_1_s1_agent:cp_channel
	...
	wire  [104:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> pio_0_s1_agent:cp_data
	wire          cmd_mux_006_src_ready;                                                              // pio_0_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire    [9:0] cmd_mux_006_src_channel;                                                            // cmd_mux_006:src_channel -> pio_0_s1_agent:cp_channel
	...
	wire    [9:0] cmd_mux_009_src_channel;                                                            // cmd_mux_009:src_channel -> pin_s1_agent:cp_channel
	...
	wire  [104:0] sysid_control_slave_agent_rp_data;                                                  // sysid_control_slave_agent:rp_data -> router_005:sink_data
	...
	wire  [104:0] onchip_memory2_1_s1_agent_rp_data;                                                  // onchip_memory2_1_s1_agent:rp_data -> router_007:sink_data
	...
	wire  [104:0] pio_0_s1_agent_rp_data;                                                             // pio_0_s1_agent:rp_data -> router_008:sink_data
	...
	wire    [9:0] cmd_demux_001_src1_channel;                                                         // cmd_demux_001:src1_channel -> cmd_mux_005:sink1_channel
	...
	wire    [9:0] rsp_demux_005_src1_channel;                                                         // rsp_demux_005:src1_channel -> rsp_mux_001:sink1_channel
	...
	wire    [9:0] router_009_src_channel;                                                             // router_009:src_channel -> new_sdram_controller_0_s1_rsp_width_adapter:in_channel
	...
	nios_system_mm_interconnect_0_cmd_mux_004 cmd_mux_005 (
		.clk                 (sys_sdram_pll_0_sys_clk_clk),                    //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_system_mm_interconnect_0_cmd_demux_001 rsp_demux_004 (
		.clk                (sys_sdram_pll_0_sys_clk_clk),                    //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_system_mm_interconnect_0_avalon_st_adapter_007 #(
		.inBitsPerSymbol (18),
		.inUsePackets    (0),
		.inDataWidth     (18),
		.inChannelWidth  (0),
